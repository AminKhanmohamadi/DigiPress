                ...
                if (data.products.length > 0) {
                    $.each(data.products, function(index, product) {
                        if (product.title) {
                            $('#results').append(
                                '<li>' +
                                '<a href="/products/product/' + product.id + '/">' + product.title + '</a>' +
                                '</li>'
                            );
                        } else {
                            console.error('Title is undefined for product: ', product);
                        }
                    });
                } else {
                    $('#results').append('<li>هیچ محصولی یافت نشد.</li>');
                }
            },
